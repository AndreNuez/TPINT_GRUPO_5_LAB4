	...
	<table class="table table-striped" style="margin: 0 auto;" id="miTabla">
		...
		<tbody>
			...
			<tr>
				...
				<td><input type="submit" value="Asignar" name="btnAsignar" class="btn btn-info" onclick="return confirm('�Est� seguro que desea asignar este paciente?')"> <input type="hidden" name = "fechaTurno" value = <%=t.getFecha()%>></td>
				</form>
			</tr>
